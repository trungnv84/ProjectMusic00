(() => {
  ...
  const ASSISTANT_SELECTORS = [
    ...
    '[class*="assistant"]', '[class*="response-content"]',
    '[class*="message-body"]', '[class*="chat"] [class*="content"]',
  ...
  async function run(prompt, timeoutMs) {
    ...
    return { ok: false, error: 'Grok: hết thời gian chờ. Hãy refresh tab hoặc kiểm tra giao diện.' };
  }
