(() => {
  ...
  const ASSISTANT_SELECTORS = [
    '[data-testid*="message"]', '[data-is-streaming]', 'div.prose',
    '[class*="assistant"]', '[class*="response-content"]', '[class*="message-body"]',
    'article', '[class*="markdown"]', '[class*="chat"] [class*="content"]'
  ];
  ...
  async function run(prompt, timeoutMs) {
    ...
    return { ok: false, error: 'Claude: hết thời gian chờ. Hãy refresh tab hoặc kiểm tra giao diện.' };
  }
