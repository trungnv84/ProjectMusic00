...
> **AI:** Kiểm tra trước khi trả file. Vi phạm **constraint** = output không chấp nhận. Mục **hint** là khuyến nghị importer-friendly.
...
2. Áp hint khi có thể (đặc biệt H2, H3).
3. Nếu có validator (`xmllint`, v.v.) thì chạy thêm.

## Related

- `KNOW.MUSICXML.RULES`, `PIPE.STEP-03`, `PIPE.STEP-04`
