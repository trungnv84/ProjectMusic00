...
tags: [compose, lyrics]
serves-steps: [3]
sources: ["docs/m-guide/knowledge/lyrics/craft.md", "docs/m-guide/meta/song-request-schema.md"]
last-updated: "2026-09-07"
---
# Lời — prosody, rhyme và trọng âm

> **AI:** Đọc ở Bước 3 khi viết lời đã có melody/form. Không dùng quy tắc này để ép mọi bài có vần hoặc cùng số chữ.
...
2. Đánh dấu trọng tâm ngữ nghĩa từng câu.
3. Chọn mẫu vần phù hợp section.
4. Đọc lời theo nhịp nói trước khi đặt toàn bộ nốt.
