...
sources:
  ...
  - "docs/m-guide/knowledge/melody/catchiness-and-hook-craft.md"
...
| `REQUIRE_CATCHINESS_SELFCHECK` | `hook_melody_cell` mô tả được thành pitch-cell+rhythm-cell ngắn (2-5 nốt); mỗi lần Chorus lặp có ≥1 biến đổi nghe được (không lặp 100% quá 2 lần liên tiếp); evidence nêu rõ theo checklist [catchiness-and-hook-craft](catchiness-and-hook-craft.md) — thiếu evidence hoặc chỉ ghi "đã catchy" không giải thích → fail |
