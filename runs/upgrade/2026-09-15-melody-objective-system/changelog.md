...
## 2026-09-16 — Gói 2 đã merge

`runs/upgrade/2026-09-16-melody-objective-package-2/` đúng phạm vi "Gói 2 — Tier 1 core mechanics, phần A":
`singability.md`, `emotional-contour.md`, `tension-release.md` + catalog patch. Merge sạch, không rebase.
